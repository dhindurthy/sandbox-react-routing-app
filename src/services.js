    ...
    <section className="services-page">
      ...
      <section className="about-section">
        ...
        <p tabIndex="0">
          ...
          graduate in Engineering. Excelled in planning and analysis, building,
          testing and maintaining User Interfaces to a state where any kind of
          web content can be handled including retail, educational, financial
          and small business websites. Skilled with over 7 years of experience
        ...
        <p tabIndex="0">
          ...
          show love for all users by providing extra help regardless of ability
          of the user. This includes users who have visual, auditory, motor or
          cognitive disabilities irrespective of the type or severity of
          impairment. I also give talks to enlighten programmers about the
          significance of accessibility in web. Please feel free to get in touch
          to strike up a conversation about web accessibility.
        </p>
        <p tabIndex="0">
          Please visit my{" "}
          <a
          ...
          dealt with in the past. Please contact me if you think I would be a
          good match to team up for your project.
        </p>
      </section>
